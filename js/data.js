...
const CAR_CLASSES = [
  ...
  // ── Single-Seater Pathway (unlocks after first prestige) ─────────────────
  {
    id: 'F4',
    name: 'Formula 4',
    fullName: 'F4 — Single-Seater Entry',
    tier: 2,
    repRequired: 1000,
    ppRequired: 1,
    baseCost: 75000,
    baseIncomePerLap: 2500,
    lapTimeSec: 8,
    maxOwned: 3,
    color: '#ff6699',
    description: 'Entry-level open-wheel racing. The bottom rung of the single-seater ladder.',
    upgradeTree: 'f1',
    pathway: 'single_seater',
  },
  {
    id: 'F3',
    name: 'Formula 3',
    fullName: 'F3 — Open Wheel',
    tier: 3,
    repRequired: 5000,
    ppRequired: 1,
    baseCost: 500000,
    baseIncomePerLap: 12000,
    lapTimeSec: 7,
    maxOwned: 2,
    color: '#ff4488',
    description: 'Serious single-seater competition. Where future champions are forged.',
    upgradeTree: 'f1',
    pathway: 'single_seater',
  },
  {
    id: 'F2',
    name: 'Formula 2',
    fullName: 'F2 — One Step From The Top',
    tier: 4,
    repRequired: 20000,
    ppRequired: 1,
    baseCost: 3000000,
    baseIncomePerLap: 50000,
    lapTimeSec: 5,
    maxOwned: 2,
    color: '#ff2266',
    description: 'The final proving ground before F1. Elite talent required.',
    upgradeTree: 'f1',
    pathway: 'single_seater',
  },
  {
...
const CHAMPIONSHIPS = [
  ...
  // ── Single-Seater Pathway championships (unlocks after first prestige) ────
  {
    id: 'formula_regional',
    name: 'Formula Regional Championship',
    shortName: 'Formula Reg.',
    allowedClasses: ['F4'],
    rounds: 8,
    roundDurationSec: 60,
    entryFee: 10000,
    ...
    finalBonusMult: 2.5,
    color: '#ff6699',
    description: 'The starting point of the single-seater ladder. 8 rounds of tight F4 action.',
    pathway: 'single_seater',
  },
  {
    id: 'formula_3_championship',
    name: 'Formula 3 Championship',
    shortName: 'F3 Champ.',
    allowedClasses: ['F3'],
    rounds: 12,
    roundDurationSec: 90,
    entryFee: 150000,
    repRequired: 3000,
    prerequisiteChampionship: 'formula_regional',
    repPerRound: 200,
    incomeBonus: 0.20,
    finalBonusMult: 3.0,
    color: '#ff4488',
    description: 'The proving ground for the next generation of F1 stars. 12 rounds.',
    pathway: 'single_seater',
  },
  {
    id: 'formula_2_championship',
    ...
    entryFee: 2000000,
    repRequired: 15000,
    prerequisiteChampionship: 'formula_3_championship',
    repPerRound: 400,
    incomeBonus: 0.30,
    finalBonusMult: 4.0,
    color: '#ff2266',
    description: 'One step from the pinnacle. Prove yourself here to reach F1.',
    pathway: 'single_seater',
  },
  {
    ...
    entryFee: 20000000,
    repRequired: 80000,
    prerequisiteChampionship: 'formula_2_championship',
    repPerRound: 500,
    incomeBonus: 0.50,
    finalBonusMult: 6.0,
    color: '#ff0055',
